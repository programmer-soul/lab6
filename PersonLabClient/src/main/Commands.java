...
public class Commands {
    ...
    public Commands() {
        ...
        commandCollection.put("save",new command.Save(this));
        commandCollection.put("load",new command.Load(this));
    ...
    public boolean sendCommandAndReceiveResponse(String comstr,String parametr) {
        try {
            ResponseList response = (ResponseList) client.sendCommandAndReceiveResponse(new Request(comstr, parametr, "testusername", ""));
            response.show();
            return true;
        } catch (IOException e) {
    ...
    public boolean sendCommandWithPersonAndReceiveResponsePerson(String comstr,String parametr,ResponsePerson person) {
        try {
            ResponseList response = (ResponseList) client.sendCommandWithPersonAndReceiveResponse(new RequestPerson(comstr, parametr, "testusername", "",person));
            response.show();
            if (response.get(0).getValue()>0){
                ResponsePersonList personlist = (ResponsePersonList) client.ReceiveResponsePerson();
                personlist.show();
