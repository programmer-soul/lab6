...
public class UDPDatagramServer {
  ...
  public UDPDatagramServer(InetSocketAddress addr, Commands commands,Logger logger) throws SocketException {
    this.addr=addr;
  ...
  public void run() {
    ...
    while (running) {
      ...
      ResponseManager responsemanager  = commands.execute(request.getCommand(),request.getParametr(),person,false);
